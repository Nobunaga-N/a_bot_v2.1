...
def main():
    ...
    # Проверка валидности лицензии - просто логируем, но не блокируем запуск
    if not license_validator.is_license_valid():
        logger.warning("Лицензия недействительна или отсутствует. Доступ к функциям бота ограничен.")
    else:
